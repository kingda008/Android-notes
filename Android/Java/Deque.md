...
![image-20210726100326776](Deque.assets/image-20210726100326776.png)
Deque接口扩展(继承)了 Queue 接口。在将双端队列用作队列时，将得到 FIFO（先进先出)行为。将元素添加到双端队列的末尾，从双端队列的开头移除元素。从 Queue 接口继承的方法完全等效于 Deque 方法，如下表所示：

![image-20210726100315268](Deque.assets/image-20210726100315268.png)
双端队列也可用作 LIFO（后进先出)堆栈。应优先使用此接口而不是遗留 Stack 类。在将双端队列用作堆栈时，元素被推入双端队列的开头并从双端队列开头弹出。堆栈方法完全等效于 Deque 方法，如下表所示：

![image-20210726100258178](Deque.assets/image-20210726100258178.png)
...
![image-20210726100553787](Deque.assets/image-20210726100553787.png)
...
原文链接：https://blog.csdn.net/devnn/article/details/82591349
